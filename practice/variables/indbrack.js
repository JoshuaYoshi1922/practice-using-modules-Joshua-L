...
// Task 2:
//console.log(booksMovies[0][0], booksMovies[0][1], booksMovies[0][2]);
//console.log(booksMovies[1][0], booksMovies[1][1], booksMovies[1][2]);
//console.log(booksMovies[2][0], booksMovies[2][1], booksMovies[2][2]);
