...
// Main program
// Need to install readline-sync if not already within project
...
while (true) {
    try {
            ...
            if (action === "add") {
                ...
                let fee = Number(readlineSync.question("Enter the adoptionfee: "));
            try {
        ...
        let animal = readlineSync.question("Enter the animal's nameto find its adoption fee: ");
                try {
